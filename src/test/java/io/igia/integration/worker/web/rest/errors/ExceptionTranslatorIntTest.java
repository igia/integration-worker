 ...
 */
package io.igia.integration.worker.web.rest.errors;
...
import io.igia.integration.worker.IntegrationworkerApp;
import io.igia.integration.worker.web.rest.errors.ErrorConstants;
import io.igia.integration.worker.web.rest.errors.ExceptionTranslator;
...
@SpringBootTest(classes = IntegrationworkerApp.class)
@ActiveProfiles("Test")
